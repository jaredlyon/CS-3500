...
public class SetGameControllerImplTest {
  ...
  public void testStartGameGoodInput() {
    ...
    assertEquals("Input first card row:", lines[14]);
  ...
  public void testStartGameFixedInput() {
    ...
    assertEquals("Input first card row:", lines[17]);
  ...
  public void testQuitAfterInvalidSet() {
    ...
    assertEquals("Time to claim a set!", lines[16]);
    assertEquals("Input first card row:", lines[17]);
    assertEquals("Input first card column:", lines[18]);
    assertEquals("Input second card row:", lines[19]);
    assertEquals("Input second card column:", lines[20]);
    assertEquals("Input third card row:", lines[21]);
    assertEquals("Input third card column:", lines[22]);
    ...
    assertEquals("Input first card row:", lines[29]);
    assertEquals("Input first card column:", lines[30]);
    assertEquals("Input second card row:", lines[31]);
    assertEquals("Input second card column:", lines[32]);
    assertEquals("Input third card row:", lines[33]);
    assertEquals("Input third card column:", lines[34]);
    ...
    assertEquals("Input first card row:", lines[41]);
    assertEquals("Input first card column:", lines[42]);
    assertEquals("Input second card row:", lines[43]);
    assertEquals("Input second card column:", lines[44]);
    assertEquals("Input third card row:", lines[45]);
    assertEquals("Input third card column:", lines[46]);
    ...
    assertEquals("Input first card row:", lines[53]);
    assertEquals("Input first card column:", lines[54]);
    assertEquals("Input second card row:", lines[55]);
    assertEquals("Input second card column:", lines[56]);
    assertEquals("Input third card row:", lines[57]);
    assertEquals("Input third card column:", lines[58]);
    ...
    assertEquals("Input first card row:", lines[65]);
  ...
  public void testQuitAfterFullGameWithInvalidSets() {
    ...
    assertEquals("Input first card row:", lines[134]);
    assertEquals("Invalid firstCardRow input! Please re-enter:", lines[135]);
    assertEquals("Input first card column:", lines[136]);
    assertEquals("Invalid firstCardCol input! Please re-enter:", lines[137]);
    assertEquals("Input second card row:", lines[138]);
    assertEquals("Invalid secondCardRow input! Please re-enter:", lines[139]);
    assertEquals("Input second card column:", lines[140]);
    assertEquals("Invalid secondCardCol input! Please re-enter:", lines[141]);
    assertEquals("Input third card row:", lines[142]);
    assertEquals("Input third card column:", lines[143]);
