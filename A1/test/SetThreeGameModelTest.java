...
/**
 * Represents the test module for SetThreeGameModel.
 */
public class SetThreeGameModelTest {

  private SetThreeGameModel illegalStateTestObject;
  ...
  public void init() {
    ...
    this.illegalStateTestObject = new SetThreeGameModel();
  ...
  public void testConstructor() {
    SetThreeGameModel testConstructor = new SetThreeGameModel();
